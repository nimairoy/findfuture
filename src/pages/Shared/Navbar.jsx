...
import imgAvatar from '../../assets/images/placeholder.jpg'
  ...
  const navItem = <>
    ...
    >
      <div className='hidden md:block'>
        <img src={user && user.photoURL ? user.photoURL : imgAvatar} alt="profile" width='30' height='30' className='rounded-full' />
      </div>
    </div>
    {isOpen && (
      <div className='absolute rounded-xl shadow-md w-[40vw] md:w-1/5 bg-white overflow-hidden right-0 top-24 text-sm'>
